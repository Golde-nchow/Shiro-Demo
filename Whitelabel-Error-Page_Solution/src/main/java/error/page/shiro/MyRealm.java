package error.page.shiro;

import error.page.dao.PermissionMapper;
import error.page.dao.RoleMapper;
import error.page.dao.UserMapper;
import error.page.model.Permission;
import error.page.model.Role;
import error.page.model.User;
